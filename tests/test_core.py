...
spec = importlib.util.spec_from_file_location(
    "azul_original", ROOT / "tests/fixtures/azul_original.py"
)
original = importlib.util.module_from_spec(spec)
spec.loader.exec_module(original)


@pytest.mark.parametrize("coverage,wmax,kr", [(10, 18.81, 0), (10, 10, 0), (60, 36, 1), (100, 5, 0)])
def test_extracted_core_matches_original_azul(coverage, wmax, kr):
...
def test_azul_april_decay_preserves_early_flow_and_caps_late_flow():
...
def test_real_azul_run_has_expected_invariants():
