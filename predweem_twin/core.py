"""Núcleo biofísico de PREDWEEM Azul 2026.

Conserva las entradas ANN, los filtros y el techo decreciente desde el 15 de
abril de LOLIUM_AZUL2026. La normalización parcial y la cobertura diaria
...
class ModelParameters:
    ...
    latitud: float = -36.8700
    longitud: float = -59.8900
    latencia_jd: int = 25
...
def calculate_et0_hargreaves(jday, tmax, tmin, latitude=-36.8700):
...
def apply_cohort_decay(
    ...
    """Conserva el techo original de Azul desde el 15/04 de cada año.
