...
def build_calibration(observations_path, weather_path, output_path, site="Azul",
                      coverage=10.0, w_max=18.81, source_metadata_path=None):
...
def main():
    ...
    parser.add_argument("--observations", type=Path, default=ROOT / "data/calibration/azul_2026_counts.csv")
    parser.add_argument("--weather", type=Path, default=ROOT / "data/calibration/azul_2026_weather.csv")
    parser.add_argument("--output", type=Path, default=ROOT / "data/calibration/azul_2026.json")
    parser.add_argument("--source-metadata", type=Path, default=ROOT / "data/calibration/azul_2026_source.json")
    parser.add_argument("--site", default="Azul")
    parser.add_argument("--coverage", type=float, default=10.0)
    parser.add_argument("--w-max", type=float, default=18.81)
