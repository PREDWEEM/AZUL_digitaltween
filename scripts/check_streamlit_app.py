"""Visita pública de Azul; comprueba la interfaz, no sólo una respuesta HTTP.
...
APP_URL = "https://srlztzpuwzpfcfcnt7yd7m.streamlit.app/"
HEADING = "Gemelo Digital · Lolium Azul"
            ...
            while time.monotonic() - started < MAX_WAIT_SECONDS:
                ...
                if ready:
                    if ready_since is None:
                        ...
                        return f"Azul operativo: indicadores y gráfico cargados ({seconds} s)."
                else:
                    ready_since = None
